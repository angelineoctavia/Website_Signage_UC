                    ...
                    <div id="playlistModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50 p-4">
                        <div class="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl relative">
                            ...
                            <div class="flex items-center space-x-3 mb-5">
                                <div
                                    class="w-10 h-10 bg-orange-100 text-uc-orange rounded-xl flex items-center justify-center">
                                    <i class="fa-solid fa-list-check text-lg"></i>
                                </div>
                                <div>
                                    <h4 id="modalPlaylistTitle" class="text-base font-bold text-uc-dark">Detail Playlist
                                    </h4>
                        ...
                        <tbody id="contentTableBody" class="divide-y divide-gray-200 text-gray-700">
                            ...
                            @empty
                                <tr id="contentEmptyRow">
                                    <td colspan="4" class="p-6 text-center text-gray-400 italic">Belum ada konten yang
                                        di-upload.</td>
                                </tr>
                            @endforelse
                            <tr id="contentNoResultRow" class="hidden">
                                <td colspan="4" class="p-6 text-center text-gray-400 italic">Tidak ada konten yang
                        ...
                        <table class="w-full text-left text-xs border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-200 text-gray-700">
                                ...
                                @forelse($signageHistories as $index => $history)
                                    <tr
                                        class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }} hover:bg-orange-50/50 transition-colors">
                                        <td class="p-3 font-semibold text-uc-dark">Playlist {{ $history->playlist_id }}
                                        </td>
        ...
        document.getElementById('btnShowSignage').addEventListener('click', function() {
            if (!selectedPlaylistId) {
                Swal.fire({
                    ...
                    text: 'Silakan klik salah satu playlist dari kalender untuk melihat detail.',
